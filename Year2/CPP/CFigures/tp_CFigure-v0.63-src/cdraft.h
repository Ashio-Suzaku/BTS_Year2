/* ----------------------------------------------------------------------------
 |	STS I.R.I.S.    Lyc�e La Fayette 0770920G
 + ----------------------------------------------------------------------------
 |
 |	Nom :			cdraft.h
 |
...
class CDraft : public XamGraph {
  ...
  public :
	...
	int getX() const { return (int)org.getX() ; }	// origine du rep�re
	int getY() const { return (int)org.getY() ; }
	void setX(int v ) { org.setX( (double)v ) ; }
	void setY(int v ) { org.setY( (double)v ) ; }

	int getScale() const { return scale ; }			// �chelle du rep�re
	void setScale(int v ) { scale = v ; }

	void draw(bool grad = false ) ;					// dessin du rep�re gradu�
